...
//        parkingLot.addAll(parkingCarWithMoney(carsWantToPark));
        ...
        //익명함수
        parkingLot.addAll(parkCars(carsWantToPark, (Car car) -> car.hasParkingTicket() && car.getParkingMoney() > 10000));
    ...
    //타입!! -> (함수형) 인터페이스
    //인터페이스 타입 역활을 할 수 었기 떄문
    //함수향 인터페이스: 추상메소드를 하나만 가지고있음!!
...
//    }
    ...
    //우의 두메소도를 하나로!! : 내부 주요 로지긍ㄹ 함수로 전답다가
